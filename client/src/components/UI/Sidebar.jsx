...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col shadow-lg justify-between max-xl:hidden xl:h-screen xl:border xl:overflow-y-auto xl:fixed xl:w-60 bg-gray-50 dark:bg-gray-800">
      <div>
