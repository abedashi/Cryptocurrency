const Settings = () => {
  return (
    <form className="max-xl:pt-4">
      <div className="shadow overflow-hidden rounded-lg">
        <div className="space-y-6 bg-white px-4 p-6">
          ...
          <div>
            ...
            <div className="mt-1 flex items-center">
              ...
              <button
                type="button"
                className="ml-5 rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
              >
                Change
              </button>
            </div>
